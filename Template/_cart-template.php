        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i> Your order is eligible for SHOPPING.</h6>
                    ...
                    <button type="submit" class="btn btn-warning mt-3"><a href="http://localhost:63342/Unimart/HTML%20Template/thank.html?_ijt=bin1qnb4k9die4fh97fllg8dm0&_ij_reload=RELOAD_ON_SAVE" >Proceed to Buy</a></button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
